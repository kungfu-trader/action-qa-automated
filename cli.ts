...
const cmdArgv = yargs(process.argv.slice(2))
    ...
    .option("bucketPrebuilt", { description: "bucketPrebuilt", type: "string", default: "kungfu-prebuilt" })
    .option("workflow_id", { description: "workflow_id", type: "string", default: "manually.yaml" })
